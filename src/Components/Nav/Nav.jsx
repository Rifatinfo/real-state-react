                    ...
                    {Links.map((link, index) => (
                        <li key={index} className="text-[#ebcfa7] hover:text-white rounded-md p-2 transition-all cursor-pointer">
                            <NavLink
                                to={link.link}
                                className={({ isActive }) =>
                                    isActive ? "text-white" : "text-[#ebcfa7]"
                                }
                            >
                                {link.name}
                            </NavLink>
                ...
                <div className="flex justify-around gap-4">
                    ...
                    {user ? (
                        <button
                            ...
                            className="btn btn-outline border-2 border-[#ebcfa7] text-[#ebcfa7] hover:bg-[#ebcfa7] hover:text-white hover:border-2 hover:border-[#ebcfa7] transition-all duration-200"
                        >
                            SignOut
                        </button>
                    ) : (
