            ...
            <div className="mt-32">
                ...
                <div className="flex justify-center space-x-8 text-center mt-8 mb-8">
                    <div className="stat-item">
                        ...
                        <p className="md:text-lg lg:text-lg text-gray-600">Properties</p>
                    </div>
                    <div className="stat-item">
                        <h3 className="lg:text-4xl md:text-4xl font-bold">
                            <CountUp start={0} end={120} duration={5} />k+
                        </h3>
                        <p className="md:text-lg lg:text-lg text-gray-600">Customers</p>
                    </div>
                    <div className="stat-item">
                        <h3 className="lg:text-4xl md:text-4xl font-bold">
                            <CountUp start={0} end={160} duration={5} />+
                        </h3>
                        <p className="md:text-lg lg:text-lg text-gray-600">Awards Won</p>
                    </div>
                </div>
            </div>
        </div>
